...
from open_mat import array_in_mat
...
# file1 = "CT_1.mat"
# file2 = "CT_2.mat"
d1 = array_in_mat(file1)
d2 = array_in_mat(file2)
img = sitk.GetImageFromArray(d1.astype(numpy.double))
img2 = sitk.GetImageFromArray(d2.astype(numpy.double))
